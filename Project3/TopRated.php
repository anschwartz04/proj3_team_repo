...
<html>
    <head>
        ...
        <title>Project 3 - Top Rated List</title>
    </head>
    <body class = header>
        <header>
            <h1>simple SCHED</h1>
        ...
        <main class = mainn>
            ...
            <section class = boxx>
                <p class = title>Top Rated Teachers</p>
                <br>
                <br>
                <?php
                    $server = "localhost";
                ...
                $conn = mysqli_connect($server, $username, $password, $database);
                    ...
                    $sql = "select fName, lName, department, avgScore from professor order by avgScore desc";
